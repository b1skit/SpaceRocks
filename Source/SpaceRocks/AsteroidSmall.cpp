...
AAsteroidSmall::AAsteroidSmall() {
	...
	AsteroidMesh->SetWorldScale3D( FVector(this->GetRandomScaleValue(), this->GetRandomScaleValue(), this->GetRandomScaleValue()) * SmallMeshScaleFactor );
	...
	if (AsteroidCollision != NULL)
		AsteroidCollision->InitSphereRadius(55.0f);						// The size of the collision mesh sphere
}
